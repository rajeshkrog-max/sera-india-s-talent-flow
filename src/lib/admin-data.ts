...
export const adminPool: AdminPerson[] = [
  ...
  { id: "CAND-0288", name: "Vikram Sethi", initials: "VS", column: "Offer", requirement: "REQ-104", stack: ".NET", origin: "YZI pool", city: "Bengaluru", experience: "7 yrs", ctc: "₹26 LPA → ₹32 LPA", notice: "90 days", email: "vikram.sethi@example.com", phone: "+91 90080 55412", skills: [".NET", "Azure", "Team lead"], matchReason: "Lead-level experience for the senior band on REQ-104.", seraNote: "Offer under negotiation. Notice period is the only open risk.", step: "Offer" },
  { id: "CAND-0321", name: "Kiran Nair", initials: "KN", column: "Placed", requirement: "REQ-088", stack: "React", origin: "YZI pool", city: "Kochi", experience: "6 yrs", ctc: "₹22 LPA → ₹28 LPA", notice: "Joined", email: "kiran.nair@example.com", phone: "+91 97450 20431", skills: ["React", "Design systems"], matchReason: "Placed on REQ-088 after a two-stage interview loop.", seraNote: "Placement closed. Documents archived in the audit trail.", step: "Placed" },
